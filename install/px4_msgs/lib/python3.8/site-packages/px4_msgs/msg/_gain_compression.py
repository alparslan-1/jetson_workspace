...
class GainCompression(metaclass=Metaclass_GainCompression):
    ...
    def __eq__(self, other):
        ...
        if self.timestamp != other.timestamp:
            return False
        if all(self.compression_gains != other.compression_gains):
            return False
        if all(self.spectral_damper_hpf != other.spectral_damper_hpf):
            return False
        if all(self.spectral_damper_out != other.spectral_damper_out):
            return False
        return True
