...
: ${AMENT_CURRENT_PREFIX:="/root/bridges/jetson_workspace/install/siha_camera_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/siha_camera_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/siha_camera_pkg/environment/path.sh"
