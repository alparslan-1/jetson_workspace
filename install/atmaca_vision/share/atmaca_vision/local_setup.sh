...
: ${AMENT_CURRENT_PREFIX:="/root/bridges/jetson_workspace/install/atmaca_vision"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/atmaca_vision/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/atmaca_vision/environment/path.sh"
