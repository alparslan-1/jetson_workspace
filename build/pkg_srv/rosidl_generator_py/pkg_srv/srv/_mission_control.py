...
class Metaclass_MissionControl_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('pkg_srv')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_MissionControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from pkg_srv.srv import _mission_control
...
class MissionControl(metaclass=Metaclass_MissionControl):
    from pkg_srv.srv._mission_control import MissionControl_Request as Request
    from pkg_srv.srv._mission_control import MissionControl_Response as Response
