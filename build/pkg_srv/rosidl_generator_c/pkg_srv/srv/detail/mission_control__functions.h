...
#ifndef PKG_SRV__SRV__DETAIL__MISSION_CONTROL__FUNCTIONS_H_
#define PKG_SRV__SRV__DETAIL__MISSION_CONTROL__FUNCTIONS_H_
...
#include "pkg_srv/msg/rosidl_generator_c__visibility_control.h"

#include "pkg_srv/srv/detail/mission_control__struct.h"

/// Initialize srv/MissionControl message.
/**
...
/// Create srv/MissionControl message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pkg_srv__srv__MissionControl_Request__init().
...
/// Destroy srv/MissionControl message.
/**
 * It calls
 * pkg_srv__srv__MissionControl_Request__fini()
...
/// Check for srv/MissionControl message equality.
/**
...
/// Copy a srv/MissionControl message.
/**
...
/// Initialize array of srv/MissionControl messages.
/**
...
/// Finalize array of srv/MissionControl messages.
/**
 * It calls
 * pkg_srv__srv__MissionControl_Request__fini()
...
/// Create array of srv/MissionControl messages.
/**
 * It allocates the memory for the array and calls
 * pkg_srv__srv__MissionControl_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MissionControl messages.
/**
 * It calls
 * pkg_srv__srv__MissionControl_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MissionControl message array equality.
/**
...
/// Copy an array of srv/MissionControl messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pkg_srv__srv__MissionControl_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pkg_srv
...
/**
 * It calls
 * pkg_srv__srv__MissionControl_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pkg_srv
...
/**
 * It allocates the memory for the array and calls
 * pkg_srv__srv__MissionControl_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pkg_srv
...
/**
 * It calls
 * pkg_srv__srv__MissionControl_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PKG_SRV__SRV__DETAIL__MISSION_CONTROL__FUNCTIONS_H_
