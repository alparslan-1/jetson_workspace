...
#include "px4_msgs/msg/detail/gain_compression__rosidl_typesupport_fastrtps_c.h"
...
static size_t _GainCompression__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4_msgs__msg__GainCompression(
...
static message_type_support_callbacks_t __callbacks_GainCompression = {
  "px4_msgs::msg",
  "GainCompression",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, GainCompression)() {
  return &_GainCompression__type_support;
}
